...
A question one commander puts to the commanders exactly one level below, with a
deadline, answers gathered in one place, and an audience limited to the two
frameworks involved.
