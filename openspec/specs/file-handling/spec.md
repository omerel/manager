...
טיפול בקבצים מקצה לקצה: גרירה-ושחרור בכל מקום שמעלים קובץ, והמרת מסמכים לטקסט בצד השרת (כולל OCR לסרוקים) לפני שהסוכן קורא אותם — כך שהסוכן נשאר קרוא-בלבד ואינו תלוי במודל מולטימודלי.
